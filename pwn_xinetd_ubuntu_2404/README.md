# pwn_xinetd_ubuntu_2404

## 环境版本

- Ubuntu 24.04.5 (noblell) amd64
- xinetd 2.3.15.4
- GLIBC 2.39-0ubuntu8.6
- patchelf 0.18.0

默认软件源为 http://mirrors.ustc.edu.cn/ubuntu
...
- 未使用chroot方式启动
- 环境内置libc二进制请查看本目录下`libc-2.39_x64.so`及`libc-2.39_x86.so`
- 环境内置ld二进制请查看本目录下`ld-2.39_x64.so`及`ld-2.39_x86.so`
