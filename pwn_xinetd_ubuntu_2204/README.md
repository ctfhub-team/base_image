# pwn_xinetd_ubuntu_2204

## 环境版本

- Ubuntu 22.04.5 (jammy) amd64
- xinetd 2.3.15.3
...
- 未使用chroot方式启动
- 环境内置libc二进制请查看本目录下`libc-2.35_x64.so`及`libc-2.35_x86.so`
- 环境内置ld二进制请查看本目录下`ld-2.35_x64.so`及`ld-2.35_x86.so`
